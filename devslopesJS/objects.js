...
var employee = {
  ...
  firstName: 'Joe',
  lastName: 'Blow',
  // method (functions and called methods when they are part of object)
  fullName: function() {
    return `${this.firstName} ${this.lastName}`;  //'this' refers to the object that own the function, in this case employee
  }
};
