...
// let sum = 0;
//
// grades.forEach(grade => sum += grade);		//ES6 fat arrow way 
//
...
let addOneMap = array.map(value => value + 1);		//ES6 fat arrow way 
...
// Filter: for filtering certain elements in an array returning all
...
//
// // FIND for filtering certain elements in an array returning the first ONE
